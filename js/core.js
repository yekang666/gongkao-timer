...
function normalizeRecordId(value, record) {
  ...
  const signature = [record.mode, record.module, record.startedAt, record.endedAt, record.duration, record.questions, record.correct, record.score, record.totalScore].join('|');
  let hash = 2166136261;
